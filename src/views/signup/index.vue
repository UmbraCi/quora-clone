    ...
    <div class="signup-page mx-auto p-3 w-330">
        ...
        <validate-form @form-submit="onFormSubmit">
            ...
            <div class="mb-3">
                ...
                <validate-input type="text" placeholder="昵称" :rules="nameRules" v-model="nicknameVal"></validate-input>
            </div>
            <div class="mb-3">
            ...
            <div class="mb-3">
                ...
                <validate-input type="password" placeholder="请再次输入密码" :rules="repeatPasswordRules" v-model="repeatPasswordVal"></validate-input>
            </div>
...
export default defineComponent({
    ...
    setup() {
        ...
        const repeatPasswordRules: RulesProp = [{ type: 'required', message: '重复密码不能为空' }];
